...
local NotificationLibrary_External = loadstring(getgenv().Game:HttpGet("https://raw.githubusercontent.com/dudeididntliterally/Backup_Repo/refs/heads/main/Notify_Lib_New.lua"))()
