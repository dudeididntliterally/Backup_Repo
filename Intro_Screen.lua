...
local random_phrase = intro_phrases[math.random(1, #intro_phrases)]
welcome_label.Text = random_phrase..", "..tostring(player_name).."."
...
wait(0.1)
getgenv().rgb_running_copyright = false
getgenv().rgb_running_welcome_label = false
