...
local setclipboard = setclipboard or toclipboard or set_clipboard or (Clipboard and Clipboard.set) or function(...) return ErrorPrompt("Attempted to set clipboard: "..(...),true) end
...
if SimpleSpy3 and SimpleSpy3:IsA("ScreenGui") then SimpleSpy3.Enabled = false end
if Background and Background:IsA("Frame") then Background.Visible = false end
-------------------------------------------------------------------------------
