...
g.Script_Owner = "😎🤫😉 Flames Hub | Owner 👑🔥😈"
...
g.cmdsString = [[
   ...
   {prefix}alwaysshowtitles (🔥 NEWEST CMD 🔥) - Always shows everyones titles / bios when they chat.
   {prefix}alwayshidetitles (🔥 NEWEST CMD [2] 🔥) - Always hides everyones titles / bios when they chat.
...
g.EnableAntiFling = function()
   ...
   g.FlamesLibrary.connect("antifling", RunService.PreSimulation:Connect(function()
