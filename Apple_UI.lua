...
function lib:init(ti, dosplash, visiblekey, deleteprevious)
    ...
    function window:Section(name)
        ...
        function sec:Slider(name, min, max, default, callback)
            ...
            container.Parent = workareamain
            container.BackgroundTransparency = 1
            container.Size = UDim2.new(0, 418, 0, 55)
            ...
            track.Position = UDim2.new(0, 0, 0.65, 0)
            ...
            UserInputService.InputChanged:Connect(function(i)
                ...
                local rounded = math.round(min + (max - min) * rel)
                value = rounded
        ...
        function sec:Switch(name, defaultmode, callback)
            ...
            Frame.MouseButton1Click:Connect(function() -- tf? I'm sorry? Did you say "Frame"??? I beg your finest pardon? Click this Frame, not a TextButton, lmao.
                mode = not mode
